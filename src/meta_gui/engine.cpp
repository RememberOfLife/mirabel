...
namespace MetaGui {
    ...
    void engine_window(bool* p_open)
    {
        ...
        bool engine_running = StateControl::main_ctrl->t_gui.engine != NULL;
        ...
        ImGui::Separator();
        if (engine_running) {
            Engines::engine_catalogue[engine_idx]->draw_state_options(StateControl::main_ctrl->t_gui.engine);
        }
        ImGui::End();
    }
