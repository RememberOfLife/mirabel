...
void mirabel_vlogf(uint32_t log_id, LOGS status, const char* fmt, va_list arg);

void mirabel_slog(LOGS status, const char* str, const char* str_end);
void mirabel_slogf(LOGS status, const char* fmt, ...);
void mirabel_svlogf(LOGS status, const char* fmt, va_list arg);
...
void mirabel_mvlogf(const char* fmt, va_list arg);
